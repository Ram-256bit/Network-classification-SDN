...
class LiveTrafficClassifier:
    def __init__(self):
        ...
        try:
            ...
            # Get the full feature names that the scaler expects
            print(f"Scaler expects {len(self.feature_names)} features: {self.feature_names}")
    ...
    def preprocess_live_data(self, df):
        ...
        # Add ALL missing features with default values (including target columns)
        ...
        # Remove target columns for prediction (keep only features)
